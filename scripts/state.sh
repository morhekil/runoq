...
validate_phase_transition() {
  ...
  case "$from:$to" in
    INIT:DEVELOP|INIT:CRITERIA|INIT:FINALIZE|INIT:FAILED|CRITERIA:DEVELOP|CRITERIA:REVIEW|CRITERIA:FAILED|DEVELOP:REVIEW|DEVELOP:FAILED|REVIEW:DECIDE|REVIEW:FAILED|DECIDE:DEVELOP|DECIDE:FINALIZE|DECIDE:INTEGRATE|DECIDE:FAILED|FINALIZE:DONE|FINALIZE:FAILED|INTEGRATE:DONE|INTEGRATE:FAILED)
      return 0
      ;;
    DONE:*|FAILED:*)
