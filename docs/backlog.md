...
- `D04`: Added `docs/architecture/flows.md` with runtime sequence diagrams for planning, execution, failure/escalation, reconciliation, mention authorization, and maintenance review triage.
